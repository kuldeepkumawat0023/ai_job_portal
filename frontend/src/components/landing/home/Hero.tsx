    ...
    >
      <div className="max-w-5xl z-10">
        ...
        >
          ...
          <span className="text-gradient italic pr-2">
            10x Faster
          </span>{" "}
          with AI
        </motion.h1>
        ...
        >
          AI-powered resume analysis, smart job matching, mock interviews,
          ATS optimization, and career growth tools to help job seekers
        ...
        >
          ...
          <Button
            variant="outline"
            size="lg"
            className="w-full sm:w-auto bg-white/50 backdrop-blur dark:bg-white/5"
            aria-label="Create free AIJobFit account"
            title="Sign Up Free"
          >
            Sign Up Free
          </Button>
      ...
      <div
        className="mt-12 md:mt-24 relative w-full max-w-5xl h-[250px] sm:h-[400px] md:h-[500px]"
        aria-label="AIJobFit dashboard preview"
      >
        ...
        >
          <Image
            ...
            alt="AIJobFit dashboard showing AI resume analysis, smart job matching and career tools"
            fill
            priority
            unoptimized
        ...
        <motion.div
          ...
          aria-label="Resume score analytics"
        >
        ...
        <motion.div
          ...
          aria-label="AI-powered job match result"
        >
          <div className="glass-card rounded-2xl p-6 border-l-4 border-secondary w-72 text-left">
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                ...
                <div className="text-[10px] uppercase font-semibold text-on-surface-variant tracking-wider">
                  San Francisco, CA
                </div>
              </div>
            </div>

            <div className="text-xl font-bold text-on-surface mt-4">
              Product Designer
            </div>

            <div className="mt-4 flex gap-2">
              <span className="px-3 py-1 bg-secondary/10 text-secondary rounded-md text-[10px] font-bold">
                96% MATCH
              </span>

              <span className="px-3 py-1 bg-surface-container-high text-on-surface-variant rounded-md text-[10px] font-bold">
                REMOTE
              </span>
            </div>
          </div>
