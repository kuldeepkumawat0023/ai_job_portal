...
/**
 * 🔒 Premium Reactivate Account Form
...
const ReactivateAccountForm = () => {
  ...
  const handleSubmit = async (
    ...
    const nErr =
      ...
      formData.newPassword.length > 15;
  ...
  return (
    <AuthSplitLayout>
      <section
        className="w-full"
        aria-labelledby="reactivate-account-heading"
      >
        {/* SEO Hidden H1 */}
        <h1 className="sr-only">
          Reactivate Your AI JobFit Account
          Securely
        </h1>
        ...
        <header className="mb-6 text-center flex flex-col items-center">
          ...
          {/* SEO Description */}
          <p
            id="reactivate-account-heading"
            className="sr-only"
          >
            Securely reactivate your AI JobFit
            account by creating a new password
            and restoring your AI job matching
            profile.
          </p>
        </header>
        ...
        <div className="mb-6 text-center">
          <div className="bg-primary/10 w-12 h-12 rounded-2xl flex items-center justify-center mx-auto mb-3 border border-primary/20">
            <RefreshCcw
              className="text-primary w-6 h-6 animate-spin-slow"
              aria-hidden="true"
            />
          </div>
          ...
          <p className="text-xs text-on-surface-variant opacity-70">
            Welcome back! Set a new password to
            reactivate your AI JobFit profile.
          </p>
        </div>
        ...
        <form
          ...
          className="space-y-4"
          aria-label="Reactivate account form"
        >
          {/* New Password */}
          <div>
            <label
            ...
            <div className="relative">
              <Lock
                className={`absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 z-10 transition-colors ${errors.newPassword
                    ? 'text-red-500'
                    : 'text-primary/70'
                  }`}
                aria-hidden="true"
              ...
              <input
                className={`w-full glass-input rounded-xl pl-10 pr-10 py-2.5 text-sm focus:ring-0 transition-all ${errors.newPassword
              ...
              <button
                ...
                className={`absolute right-3.5 top-1/2 -translate-y-1/2 transition-colors ${errors.newPassword
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                className={`w-full glass-input rounded-xl pl-10 pr-10 py-2.5 text-sm focus:ring-0 transition-all ${errors.confirmPassword
                    ? '!border-red-500 !ring-red-500/10'
                    : ''
                  }`}
                id="confirmPassword"
              ...
              <button
                ...
                className={`absolute right-3.5 top-1/2 -translate-y-1/2 transition-colors ${errors.confirmPassword
                    ? 'text-red-500 hover:text-red-600'
                    : 'text-primary/70 hover:text-primary'
                  }`}
              >
          ...
          <button
            disabled={loading}
            type="submit"
            aria-label="Reactivate account and continue"
          ...
          <div className="mt-3 flex items-center justify-center gap-2 px-4 py-1.5 bg-primary/5 backdrop-blur-sm rounded-lg border border-primary/10">
            ...
            <p className="text-[11px] leading-tight text-on-surface-variant italic">
              ...
              Reactivating reconstructs your
              profile vector in our job matching
              engine.
            </p>
          </div>
        </form>
