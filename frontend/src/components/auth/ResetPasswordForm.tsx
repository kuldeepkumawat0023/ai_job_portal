...
import { ShieldCheck, Lock, Eye, EyeOff, Save, Bot, Sparkles, BrainCircuit } from 'lucide-react';
import AuthSplitLayout from './AuthSplitLayout';

/**
 * 🔒 Premium Reset Password Form (Full Validation & Split Layout)
 */
    ...
    <AuthSplitLayout>
      {/* Brand Header */}
            ...
            <div className="mb-6 text-center">
              ...
              <h2 className="text-xl font-bold text-primary mb-1">Set New Password</h2>
              <p className="text-xs text-on-surface-variant opacity-70">Create a secure password for your account.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                ...
                {!loading && <Save className="relative z-10 w-4 h-4" />}
              ...
              <div className="mt-3 flex items-center justify-center gap-2 px-4 py-1.5 bg-primary/5 backdrop-blur-sm rounded-lg border border-primary/10">
                ...
                <p className="text-[11px] leading-tight text-on-surface-variant italic">
                  <span className="font-semibold text-primary">AI Insight:</span> A strong password ensures safe semantic ranking matching.
                </p>
              </div>
            </form>
    </AuthSplitLayout>
