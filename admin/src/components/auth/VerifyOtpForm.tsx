...
const AdminVerifyOtpForm = () => {
  ...
  return (
    <AdminAuthSplitLayout>
      <section
        className="w-full"
        aria-labelledby="admin-verify-otp-heading"
      >
        {/* SEO Hidden H1 */}
        <h1 className="sr-only">Verify OTP Code — AI JobFit Admin Panel</h1>
        ...
        <div className="w-full mx-auto text-center">
          ...
          <header className="mb-8">
            ...
            <h2 id="admin-verify-otp-heading" className="text-2xl font-bold text-primary mb-2">
              Check Your Email
            </h2>
            ...
            <p className="sr-only">
              Enter the OTP code sent to your admin email to securely verify and continue the password reset process.
            </p>
          </header>

          {/* OTP Form */}
          <form onSubmit={handleSubmit} className="space-y-8" aria-label="Admin OTP verification form">
            <div className="flex justify-center flex-col items-center">
              <div className="relative group">
                ...
                <input
                  className={`w-full max-w-[280px] glass-input rounded-2xl px-4 py-5 text-center text-4xl font-bold tracking-[0.5em] outline-none transition-all ${error
                    ? '!border-red-500'
                    : ''
                    }`}
                  id="admin-otp"
              ...
              {error && (
                <p id="admin-otp-error" className="text-[10px] text-red-500 mt-3 font-bold tracking-tight">
                  {error}
                </p>
              )}
            </div>
            ...
            <button
              disabled={loading}
              type="submit"
              aria-label="Verify admin OTP code"
