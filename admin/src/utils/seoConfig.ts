export const defaultSEO = {
    ...
    title: "AIJobFit - Super Admin Panel",
    description:
        "Super Admin control panel for the AIJobFit hiring platform. Manage users, recruiters, job postings, and analyze platform metrics.",
    keywords: "AIJobFit, admin panel, super admin, hiring platform, metrics, user management",
    url: "/",
